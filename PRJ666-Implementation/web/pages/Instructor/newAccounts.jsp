        ...
        <td>
            ...
            <%
                if(!errorFound) {
                    ...
                    subject = "Seneca Project Management - Team Account Created";
                    
                    Email emailer = new Email();
                    emailer.addRecipient(Message.RecipientType.TO, emailTo);
                    if(userBean.addTeam(a) && emailer.sendEmail(emailFrom, subject, body)) {
